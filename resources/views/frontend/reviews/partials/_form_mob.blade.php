      ...
      <form data-action="{{ route('review.create') }}">
        ...
        <div class='inp_attech'>
          ...
          <label  style="position: relative">
            ...
            <input class='attach_input' type='file' name="author_image" id="author_image_mob" accept="image/*">
            <span id="count_author_image_mob"></span>
          </label>
        </div>
        <p>Номер договора:</p>
        ...
        <div class='sumbit_send'>
          ...
          <label style="position: relative">
            <div class='attach__up'>  <span id="count_images_files_mob"></span> </div>
            <input class='attach_input' id="images_files_mob" type='file' name="images" accept="image/*" multiple>
          </label>
