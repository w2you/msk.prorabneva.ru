    ...
    <section class='our__team__info'>
        <div class='wrapper_new-n'>
            <div class='our__team__info--title'>
                <span>Наша команда более 10 лет выполняет комплексные работы,</span>
                связанные с дизайном интерьера частных помещений под ключ
                <br>
                в городе Санкт-Петербург.
            </div>
            <div class='flex_block_n'>
                <div class='left__text'>
                    <p>Мы с радостью создадим для Вас дизайн интерьера, отличающийся исключительной красотой,
                        функциональностью и приемлемой ценой, а также возьмем на себя все хлопоты, касающиеся выбора
                        отделочных материалов, предметов мебели и декоративных элементов.</p>
                    <p>В нашей команде трудятся высококвалифицированные специалисты, способные воплотить в жизнь
                        практически
                        любой проект дизайна интерьера и средового дизайна.</p>
                    <p>Отдельный подход к каждому клиенту, знания, помноженные на опыт – вот главные принципы нашей
                        деятельности.</p>
                </div>
...
<i class='fa fa-rub'></i>
        ...
        <div class='wrapper_new-n'>
            ...
            <div class='flex_block_n really_designer--blocks'>
                <div class='left_block w_50'>
                    <p>Давайте подумаем вместе, как поступить правильно. Мы убеждены, что наши клиенты талантливые люди
                        и
                        при желании могут придумать сногсшибательные идеи. А некоторые могут и самостоятельно их
                        воплотить в
                        готовом дизайн-проекте для рабочих.</p>
                    <p>И, скажем, честно, простой ненавязчивый проект в европейском стиле спланировать под силу каждому,
                        равно как выполнить простой ремонт своими руками. НО!</p>
                ...
                <div class='right_block w_50'>
                    <div class='flex_block_n'>
                        <div class='w_50'>
                            ...
                            <p>
                                Если вы хотите уйти от стандартных решений и избежать обыденности в интерьере
                            </p>
                        </div>
                        <div class='w_50'>
                            <div class='icon_check'>
                            ...
                            <p>
                                Если у вас есть блестящая идея дизайн-интерьера, но
                                вы не можете придумать
                                ей достойного выражения
                                в текстуре
                            </p>
                        </div>
                        <div class='w_50'>
                            ...
                            <p>
                                Если вам важно, чтобы каждая деталь была подобрана
                                со вкусом и знанием законов сочетаемости
                            </p>
                        </div>
                        <div class='w_50'>
                            <div class='icon_check'>
                            ...
                            <p>
                                Если вы дорожите своим временем и не готовы только
                                на основе просмотренных фото и передач экспериментировать со стройматериалами
                                и собственным жильем, то без грамотного дизайнера никуда!
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class='information_section information_section--bg-one'>
        <div class='wrapper_new-n'>
            <h2 class='title_section_g'>
                Грамотный специалист по дизайну
                <br>
                интерьеров от Прораб НЕВА
            </h2>
            <div class='information__section--overflow information__section--overflow--block_num'>
                <div class='flex_block_n flex_block_n-wrap'>
                    <div class='information__section--block information__section--block-big'>
                        ...
                        <p>Разработает цветовую схему помещений в соответствии с вашими пожеланиями, особенностями
                            планировки и освещения</p>
                    </div>
                    <div class='information__section--block information__section--block-big'>
                        <div class='information__section--block-star'>
                            <img src='/frontend/images_4/Star_white.png'>
                        </div>
                        <p>Выберет правильную текстуру материалов для всех поверхностей, чтобы в квартире было
                            комфортно</p>
                    </div>
                    <div class='information__section--block information__section--block-big'>
                        <div class='information__section--block-star'>
                        ...
                        <p>Запланирует точки искусственного освещения, чтобы в итоге оформление заиграло так, как вам
                            мечталось</p>
                    </div>
                    <div class='information__section--block information__section--block-big'>
                        <div class='information__section--block-star'>
                        ...
                        <p>Спланирует расположение выключателей и розеток в соответствии с будущей планировкой</p>
                    </div>
                    <div class='information__section--block information__section--block-big'>
                        <div class='information__section--block-star'>
                            <img src='/frontend/images_4/Star_white.png'>
                        ...
                        <p>
                            Определит цветовые дизайнерские акценты из текстиля, декоративных объектов из стекла,
                            дерева,
                            керамики
                        </p>
                    </div>
                    <div class='information__section--block information__section--block-big'>
                        ...
                        <p>Подберет мебель, форму и очертания будущих диванов, шкафов, зеркал в соответствии с
                            дизайн-проектом</p>
                    </div>
                </div>
            </div>
    ...
    <section class='our__team__info--int'>
        <div class='wrapper_new-n'>
            <div class='our__team__info--title'>
                ...
                в новом дизайне квартиры специалист профессионально создаст для вас уникальное уютное пространство «под
                ключ», в котором вам будет комфортно.
            </div>
            <div class='flex_block_n'>
                <div class='left__text'>
                    <p>Несколькими взмахами карандаша он придаст видимые очертания вашей мечте и поможет воплотить ее в
                        жизнь.</p>
                    <p>Подумайте, ведь такого случая может больше не представиться: ремонт просто так – на раз-два – не
                        переделать. Это серьезное мероприятие, требующее серьезных вложений вне зависимости от того,
                        привлекаете вы дизайнера или нет.</p>
                    <p>А хороший дизайнер к тому же знает модные тенденции в оформлении интерьеров, отслеживает тренды
                        при
                        помощи выставок, профессиональных фестивалей, профжурналов и т.д.</p>
                </div>
                <div class='right__img'>
            ...
            <div class='flex_block_n'>
                <div class='left_block'>
                    ...
                    <div class='info__block'>
                        <p>При заказе комплексного ремонта получите технический проект квартиры в подарок —
                            индивидуально
                            разработанный для вашего интерьера план расстановки мебели, размещения светильников, розеток
                            и
                            выключателей.</p>
                        <p>
                            Высказывайте любые пожелания по услуге – вместе
                            с дизайнером интерьера вы найдете оптимальные решения, сделаете свой дом уютным и удобным!
                        </p>
                    </div>
                ...
                <div class='right_block'>
                    <div class='info__block'>
                        ...
                        <p>Для этого нужно обратиться к нашим сотрудникам и заказать комплексный ремонт квартиры по
                            телефону
                            или на сайте.</p>
                    </div>
                    <div class='info__block'>
                        ...
                        <p>
                            В этом случае компания «Прораб НЕВА» в
                            <br>
                            Санкт-Петербурге подготовит технический дизайн-проект квартиры бесплатно, а рабочие выполнят
                            ремонт «под ключ» в точности с намеченным планом.
                        </p>
                    </div>
                    <div class='info__block'>
                        <div class='info__block--img'>
                        ...
                        <p>
                            В техническую документацию входит:
                        </p>
                        <ul>
                            <li>— планировка квартиры/помещений;</li>
                            <li>— план освещения, развязки выключателей и розеток;</li>
                            <li>— составление плана расстановки мебели</li>
                        </ul>
                        <p>
                            Вам останется только купить и расставить мебель так,
                            как запланировано в эскизах, и пригласить друзей на новоселье!
                        </p>
                    </div>
                </div>
            </div>
