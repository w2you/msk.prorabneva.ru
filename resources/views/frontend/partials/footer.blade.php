  ...
  <div class='wrapper_new'>
    <div class='clearfix'>
      <div class='footer_left_block' itemscope itemtype="http://schema.org/Organization">
        <div class='clearfix'>
          <div class='tel_info' itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">

			@if(isset($selectRegion))
            <div class="ya-phone"><a class='tel roistat-phone' href="tel:{{$selectRegion->phone}}"
          ...
          <div class='soc'>
            @foreach($socialMedia as  $social)
              <a rel="nofollow" href='{{$social->link}}'>
                <img src='{{asset('storage/' . $social->image) }}' alt='Прораб Нева'>
                <img src='{{asset('storage/' . $social->image_hover) }}' alt='Прораб Нева'>
              </a>
            @endforeach
          </div>
        </div>
        <div class='footer_menu'>
          <div class='block'>
            <div class='footer_title_menu'>Наши услуги</div>
            <ul>
              <li>
                <a href='/remont-domov'>Ремонт частных домов</a>
              </li>
              <li>
                <a href='/remont-kommerceskih-pomeshenij'>Ремонт для бизнеса</a>
              </li>
              <li>
          ...
          <div class='block'>
            <div class='footer_title_menu'>Прораб НЕВА</div>
            <ul>
            <!--<li>
                                <a href='{{ route('about') }}'>О компании</a>
                            </li>-->
              <li>
                <a href='{{ route('our_team') }}'>Сотрудники</a>
              </li>
              ...
              <li>
                <a href='{{ route('letter-director') }}'>Письмо директору</a>
              </li>
            </ul>
          </div>
          <div class='block'>
            <div class='footer_title_menu'>Популярное</div>
            <ul>
              <li>
                <a href='{{ route('calculator') }}'>Калькулятор ремонта</a>
              </li>
              <li>
                <a href='{{ route('salePromotions') }}'>Акции и скидки</a>
              </li>
              <li>
                <a href='{{ route('portfolio') }}'>Готовые ремонты</a>
              </li>

              <li>
                <a href='{{route('priceList')}}'>Прайс на работы</a>
              </li>
      ...
      <div class='footer_right_block'>
        <div class='title_form_block'>Заказать звонок</div>
        <form>
          ...
          <input class='submit_call' type='button' data-url="{{route('emailFooter')}}" value='Позвоните мне '>
        </form>
      </div>
    </div>
