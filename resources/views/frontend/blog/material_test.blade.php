  ...
  <section class='page_blog'>
    <div class='wrapper_new'>
      ...
      {{--@foreach($material->contents as $post_content)--}}
        {{--@include('frontend.blog.materyal_content.type_' . $post_content['type'])--}}
      {{--@endforeach--}}
      {!! $material['body'] !!}
      <div class='blocks_all_width'>
        <div class='share_block'>
          <div class='img_name_info'>
            ...
            <div class='data_name'>
              <div class='data'>{{\App\Helpers\Helper::getDateMonth(\Carbon\Carbon::parse($material['date'])->formatLocalized('%d %B %Y'))}}</div>
