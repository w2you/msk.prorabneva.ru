                ...
                <div class="panel panel-bordered">
                    ...
                    <!-- CSRF TOKEN -->
                        ...
                        <!-- Adding / Editing -->
                            ...
                            @include('vendor.voyager.blocks.meta_tags', ['pageData' => $dataTypeContent])
                            @include('vendor.voyager.category-services.partials.banner_top')
                                @include('vendor.voyager.category-services.partials.banner_bottom')

                            {{--@include('vendor.voyager.blocks.faq', ['pageData' => $dataTypeContent])--}}
