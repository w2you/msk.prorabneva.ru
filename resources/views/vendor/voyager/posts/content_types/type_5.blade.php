...
<div class="panel panel-bordered">
  ...
  @endif
  <input type="hidden" class="content-sort" data-sort="{{'5_' . $key}}" name="contents[{{'5_' . $key}}][id]" value="{{$post_content['id'] ?? 0}}">
  <div class="panel-body">
    <div class="row">
      <div class="form-group col-md-12">
        <label for="name">Заголовок h2</label>
        <input required="" type="text" class="form-control" name="contents[{{'5_' . $key}}][title]"
      ...
      <div class="clone-wrapper">
        ...
        @forelse( $post_content->texts ?? [] as  $item )
          <div class="toclone form-group">
            <div class="col-sm-9">
              <textarea name="contents[{{'5_' . $key}}][texts][]" cols="30" rows="3" class="form-control"
