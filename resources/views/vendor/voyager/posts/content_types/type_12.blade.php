...
<div class="panel panel-bordered">
  ...
  @endif
  <input type="hidden" class="content-sort"  data-sort="{{'12_' . $key}}" name="contents[{{'12_' . $key}}][id]" value="{{$post_content['id'] ?? 0}}">
  <div class="panel-body">
    <div class="row">
      <img src="{{ voyager_asset('images/post_content/gotovi.png') }}" alt="" height="200">
    </div>
  </div>
