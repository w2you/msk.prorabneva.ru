...
<div class="panel panel-bordered">
  ...
  @endif
  <input type="hidden" class="content-sort"  data-sort="{{'11_' . $key}}" name="contents[{{'11_' . $key}}][id]" value="{{$post_content['id'] ?? 0}}">
  <div class="panel-body">
    <div class="row">
      <img src="{{ voyager_asset('images/post_content/kompleksnaya_primerka.png') }}" alt="" height="200">
    </div>
  </div>
