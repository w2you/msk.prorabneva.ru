        ...
        <div class="panel">
            ...
            <div class="page-content settings container-fluid">
                ...
                <div class="tab-content">
                    ...
                    @endforeach
                    <div id="regions" class="tab-pane fade in ">
                        <div class="panel">
                            <div class="page-content container-fluid">
                                <div id="region" class="tab-pane fade in">
                                    ...
                                    <div class="panel-heading">
                                        <h3 class="panel-title">
                                            Автозаполнение страниц городов
                                        </h3>
                                    </div>
                                    <div class="panel-body no-padding-left-right">
                                        <div class="col-md-10 no-padding-left-right">
                                            <ul>
                                                @foreach(\App\Models\Region::where(['is_default'=>0])->get() as $city)
                                                <li>
                                                    <span style="width:200px;">{{ $city->title }}</span>
                                                    <a class="btn btn-primary" href="{{ route('admin.regions.copypages', ['region_id'=>$city->id ]) }}" title="Копировать страницы"> <span class="icon voyager-list-add"></span></a>
                                                    <a class="btn btn-danger" href="{{ route('admin.regions.deletepages', ['region_id'=>$city->id ]) }}" title="Удалить страницы"> <span class="icon voyager-x"></span></a>
        ...
        <div class="panel-body">
            <form action="{{ route('voyager.settings.store') }}" method="POST">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" name="key" placeholder="{{ __('voyager::settings.help_key') }}"
                           required="required">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-12">
                    <a id="toggle_options"><i
                            class="voyager-double-down"></i> {{ mb_strtoupper(__('voyager::generic.options')) }}</a>
...
@endif
<div class="page-content settings container-fluid">
    <form action="{{ route('voyager.settings.robot.update') }}" method="POST" enctype="multipart/form-data">
        {{ method_field("PUT") }}
        {{ csrf_field() }}
        <div class="panel">
            <div class="page-content container-fluid">
                <div id="robot" class="tab-pane fade in">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            Robot.txt
                        </h3>
                    ...
                    <div class="panel-body no-padding-left-right">
                        <div class="col-md-10 no-padding-left-right">
                            <textarea class="form-control" rows="25"
                                      name="robot_txt">{{file_get_contents(public_path('robots.txt'))}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
