    ...
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1 form-group">
            ...
            <input type="text" name="faq[title]" class="form-control"
                   value="@isset($pageData->faq->title){{ $pageData->faq->title }}@else{{''}}@endisset">
        </div>

        <div class="faq-list">
            @if(isset($pageData->faq->items) && count( $pageData->faq->items) > 0)
                @foreach( $pageData->faq->items as $key => $item)
