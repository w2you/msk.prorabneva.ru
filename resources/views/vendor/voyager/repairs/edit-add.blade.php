                            ...
                            @foreach($dataTypeRows as $row)
                                @if($row['id'] == 151)
                                    ...
                                    <div class="form-group  col-md-12">
                                        ...
                                        <button class="btn btn-primary save-before-sorting"> Save Sorting</button>
                                        <div class="sortable">
                                            <br>
                                            @if(isset($dataTypeContent->{$row->field}))
                                                <?php $images = $dataTypeContent->imagesBefore; ?>
                                                @if($images != null)
                                                    @foreach($images as $image)
                                                        <div class="img_settings_container class_image"
                                        ...
                                        <input @if($row->required == 1) required @endif type="file"
                                ...
                                @elseif($row['id'] == 152)
                                    ...
                                    <div class="form-group  col-md-12">
                                        ...
                                        <div class="sortable2">
                                            <br>
                                            @if(isset($dataTypeContent->{$row->field}))
                                                <?php $images = $dataTypeContent->imagesAfter; ?>
                                                @if($images != null)
                                                    @foreach($images as $image)
                                ...
                                @elseif($row['id'] == 154)
                                    ...
                                    <div class="form-group  col-md-12">
                                        <label for="name">{{ $row->display_name }}</label>
                                        <button class="btn btn-primary save-project-sorting"> Save Sorting</button>
                                        <div class="sortable3">
                                            <br>
                                            @if(isset($dataTypeContent->{$row->field}))
                                                <?php $images = $dataTypeContent->imageDesignProject; ?>
                                                @if($images != null)
                                                    @foreach($images as $image)
                                                        <div class="img_settings_container class_image2"
                                                             data-image="{{ $image->id }}"
                                ...
                                @elseif($row['id'] == 446)
                                    ...
                                    <div class="form-group  col-md-12">
                                        ...
                                        <div class="sortable4">
                                            <br>
                                            @if(isset($dataTypeContent->{$row->field}))
                                                <?php $images = $dataTypeContent->imageReviews; ?>
                                                @if($images != null)
                                                    @foreach($images as $image)
                                                        <div class="img_settings_container class_image2"
                                                             data-image="{{ $image->id }}"
...
@section('javascript')
    <script>
        ...
        $('document').ready(function () {
            ...
            $('#confirm_delete').on('click', function () {
                $.post('{{ route('remove_image') }}', params, function (response) {
                    if (response
                        && response.data
    ...
    <script>
        ...
        $(document).on('click', '.save-before-sorting', function (e) {
            e.preventDefault();
            let url = '{{ route('update_image') }}';
            let images = [];

            $(".sortable .class_image").each(function () {
        ...
        $(document).on('click', '.save-after-sorting', function (e) {
            ...
            let url = '{{ route('update_image') }}';
            let images = [];
            $(".sortable2 .class_image2").each(function () {
                images.push($(this).data('image'));
            });
            $.ajax({
                url: url,
        ...
        $(document).on('click', '.save-project-sorting', function (e) {
            e.preventDefault();
            let url = '{{ route('update_image') }}';
            let images = [];
            $(".sortable3 .class_image2").each(function () {
                images.push($(this).data('image'));
            });
            $.ajax({
                url: url,
        ...
        $(document).on('click', '.save-project-sorting', function (e) {
            ...
            let url = '{{ route('update_image') }}';
            let images = [];
            $(".sortable4 .class_image2").each(function () {
                images.push($(this).data('image'));
            });
            $.ajax({
                url: url,
