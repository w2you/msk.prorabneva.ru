...
class CategoryChildPriceListController extends VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $validatorWhyWeImage = Validator::make($request->all(), ['why_we.*.image' => 'image']);
        try {
            if ($validatorWhyWeImage->fails()) {
                throw new ExceptionNotXHR($validatorWhyWeImage->errors());
            }
            CategoryMainRepairHelper::saveWhyWeImages($request, $data);
